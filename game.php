<?php
    ...
    //counting score for the players    
...
<html lang="en">
    ...
    <div class="main">
        ...
        <div id="center" class="igram">
            <form name="Form" id="form" method="post" autocomplete="off" action="<?php if($_SESSION["stevVrz"]==$_SESSION["stevMet"]){echo 'ending.php';}else{echo 'game.php';}?>">
                <div class="igralci">
                    <?php echo $_SESSION["p1"];  ?></br>
                    <?php echo $_SESSION["p1Score"];  ?></br>
                    <?php  for ($x = 0; $x <$_SESSION["stevKoc"] ; $x++) {
                        echo "<img src='images/dice".  $p1Met[$x]. ".gif' alt='dice1' class='dice'>";
                    }?></br>
                </div>
                <div class="igralci">
                    ...
                    <?php  for ($x = 0; $x <$_SESSION["stevKoc"] ; $x++) {
                        echo "<img src='images/dice".  $p2Met[$x]. ".gif' alt='dice1' class='dice'>";
                    }?></br>
                </div>
                <div class="igralci">
                    ...
                    <?php  for ($x = 0; $x <$_SESSION["stevKoc"] ; $x++) {
                        echo "<img src='images/dice".  $p3Met[$x]. ".gif' alt='dice1' class='dice'>";
                    }?></br>
                </div>
                <div class=down>
                        <input class="button-5 button   " type="submit" id="gumb" value="<?php if($_SESSION["stevVrz"]==$_SESSION["stevMet"]){echo 'Results';}else {echo 'Throw';}  ?>">
                    </br>
